...
import org.cytoscape.PModel.internal.Tasks.ResetEdgeView;
...
public class ResetEdgeViewFactory extends AbstractEdgeViewTaskFactory{
	...
	public TaskIterator createTaskIterator(View<CyEdge> edgeView, CyNetworkView netView) {
		return new TaskIterator(new ResetEdgeView(edgeView, netView));
