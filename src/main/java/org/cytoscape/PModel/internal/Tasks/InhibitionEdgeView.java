...
public class InhibitionEdgeView extends AbstractTask {
	...
	public InhibitionEdgeView(CyServiceRegistrar registrar) {
		this.registrar = registrar;
	}
	
	
	public InhibitionEdgeView(View<CyEdge> edgeView, CyNetworkView netView) {
