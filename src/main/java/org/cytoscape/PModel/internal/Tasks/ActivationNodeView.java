...
public class ActivationNodeView extends AbstractTask {
	...
	public ActivationNodeView(CyServiceRegistrar registrar) {
	...
	public void run(TaskMonitor monitor) {
		...
		if (nodeTable.getColumn(columnName) == null) {
			...
			for (CyNode node : Nodes) {
				...
				nodeTable.getRow(node.getSUID()).set(IMAGE_COLUMN, one); 
			}
