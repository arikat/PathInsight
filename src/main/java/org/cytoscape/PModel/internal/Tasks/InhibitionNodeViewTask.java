...
public class InhibitionNodeViewTask extends AbstractTask {
	...
	public InhibitionNodeViewTask(CyServiceRegistrar registrar) {
		this.registrar = registrar;
	}
	
	
	public InhibitionNodeViewTask(View<CyNode> nodeView, CyNetworkView netView) {
	...
	public void run(TaskMonitor monitor) {
		...
		if (nodeTable.getColumn(columnName) == null) {
			...
			for (CyNode node : Nodes) {
				...
				nodeTable.getRow(node.getSUID()).set(IMAGE_COLUMN, negone); 
			}
