...
import org.cytoscape.PModel.internal.Taggable;

public class UpArrowAppearance extends CustomGraphics<ImageCustomGraphicLayer> 
{
	private CyCustomGraphics actualCustomGraphics;
	private final String serializationString;
	
	public UpArrowAppearance(final String serializationString, final Long id, final String name,
			final CustomGraphicsFactory factory)
			throws IOException {
		super(id, name, CustomGraphics.Image);
	...
	public CyCustomGraphics reloadImage() {
		...
		if (cg != null && cg instanceof UpArrowAppearance == false)
	...
	public Image resetImage() {
		if (actualCustomGraphics instanceof CustomGraphics)
			return ((CustomGraphics)actualCustomGraphics).resetImage();
	...
	protected String getTypeName() {
		return CustomGraphics.class.getCanonicalName();
	}
