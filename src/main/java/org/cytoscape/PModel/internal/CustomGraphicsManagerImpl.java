...
import org.cytoscape.PModel.internal.UpArrowAppearance;
import org.cytoscape.PModel.internal.CustomGraphics;
...
public final class CustomGraphicsManagerImpl implements CustomGraphicsManager 
{
	...
	private final Set<UpArrowAppearance> upArrowSet = new HashSet<>();
...
//	}
	...
	public Collection<CyCustomGraphics> getAllPersistantCustomGraphics() {
		...
		for (CyCustomGraphics cg: getAllCustomGraphics()) {
			...
			if (cg instanceof CustomGraphics) {
				CustomGraphics urlCG = (CustomGraphics)cg;
...
/*	@Override
	...
	@Override
	public void addMissingImageCustomGraphics(final UpArrowAppearance cg) {
		missingImageCustomGraphicsSet.add(cg);
	}

	@Override
	public Collection<UpArrowAppearance> reloadMissingImageCustomGraphics() {
		final Set<UpArrowAppearance> reloadedSet = new HashSet<>();
		
		for (final UpArrowAppearance mcg : missingImageCustomGraphicsSet) {
...
/*
		...
		public void run(final TaskMonitor taskMonitor) throws Exception {
			final Collection<UpArrowAppearance> reloaded = reloadMissingImageCustomGraphics();
...
/*
	...
	@Override
	public void addMissingImageCustomGraphics(UpArrowAppearance cg) {
		// TODO Auto-generated method stub
