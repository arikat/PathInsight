...
public class trialattemptfactory extends AbstractTaskFactory implements NodeViewTaskFactory {

	private CyServiceRegistrar registrar;
	private CyApplicationManager manny;

	public trialattemptfactory(CyServiceRegistrar registrar, final CyApplicationManager manny) {
	...
	public TaskIterator createTaskIterator(View<CyNode> nodeView, CyNetworkView netView) {
		return new TaskIterator(new trialattempt(nodeView, netView, registrar, manny.getCurrentNetwork())); //add manny in a bit
	}
}